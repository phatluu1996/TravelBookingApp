                                        ...
                                        <div className="card-body py-0 px-0 px-sm-3">
                                            <div className="row align-items-center">
                                                <div className="col-4 col-sm-3 col-xl-2">
                                                    <img src="./assets/images/dashboard/Group126@2x.png" className="gradient-corona-img img-fluid" calt="" />
                                                </div>
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <div className="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
                                                <div className="item">
                                                    <img src="./assets/images/dashboard/Rectangle.jpg" calt="" />
                                                </div>
                                                <div className="item">
                                                    <img src="./assets/images/dashboard/Img_5.jpg" calt="" />
                                                </div>
                                                <div className="item">
                                                    <img src="./assets/images/dashboard/img_6.jpg" calt="" />
                                                </div>
                                            </div>
                                            <div className="d-flex py-4">
                                                <div className="preview-list w-100">
                                                    <div className="preview-item p-0">
                                                        <div className="preview-thumbnail">
                                                            <img src="./assets/images/faces/face12.jpg" className="rounded-circle" calt="" />
                                                        </div>
                                                        <div className="preview-item-content d-flex flex-grow">
                                                            <div className="flex-grow">
                                                                <div className="d-flex d-md-block d-xl-flex justify-content-between">
