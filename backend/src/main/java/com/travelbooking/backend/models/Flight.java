...
public class Flight {
    ...
    public Flight(Long id, String flightCode, Airline airline, String departureCity, String arrivalCity, String departureTime, String arrivalTime, String description, int economyCapacity, Float economyPrice, int businessCapacity, Float businessPrice, String status) {
        this.id = id;
