...
import { BsListCheck, BsBookmark, BsPencil, BsBarChart } from 'react-icons/bs'
...
import { AiOutlineUser, AiOutlinePoweroff, AiOutlineYoutube, AiOutlineExclamationCircle } from 'react-icons/ai'
...
import AddNewFlight from '../../components/addlisting/AddNewFlight';
function useQuery() {
                                    ...
                                    <TabList className="nav nav-tabs border-0" id="nav-tab">
                                        <Tab>
                                            <div className="nav-item nav-link theme-btn pt-0 pb-0 mr-1">
                                                <span className="la"><BsListCheck /></span> Flights List
                                            </div>
                                        </Tab>
                                        <Tab>
                                            <div className="nav-item nav-link theme-btn pt-0 pb-0 mr-1">
                                                <span className="la"><CgAirplane /></span> Airline Profile
                                            </div>
                                        </Tab>
                                        <Tab>
                                            <div className="nav-item nav-link theme-btn pt-0 pb-0 mr-1">
                                                <span className="la"><BsBarChart /></span> Bookings List
                                            </div>
                                        </Tab>
                                    </TabList>
                                    <div className="btn-box">
                                        <Link to="/" className="theme-btn ml-1"><span className="la mb-2 mr-1"><GiHouse /></span> Home</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-12">
                                    ...
                                    <TabPanel>
                                        ...
                                        <div className="row container">
                                            <Table responsive="lg" bordered hover size="lg">
                                                ...
                                                {airline?.flights?.map((flight, i) => {
                                                    return (                                                                                                                    
                                                        <tbody>
                                                            <tr key={i+1} className="card-content-wrap">
                                                                <td>{i+1}</td>
                                                                ...
                                                                <td>{flight.businessCapacity}</td>
                                                                <td>{flight.economyCapacity}</td>
                                                                <td>{flight.aircraftType}</td>
                                                                <td>{flight.status}</td>
                                                                <td className="edit-info-box">
                                                ...
                                                <div className="user-profile-action">
                                                    ...
                                                    <div className="user-details">
                                                        ...
                                                        <ul className="list-items mt-3">
                                                            <li>
                                                                <span className="la d-inline-block"><GiPositionMarker /></span>   {airline?.location?.province?.name}
                                                            </li>
                                                            <li className="text-lowercase">
                                                                <span className="la d-inline-block"><FiPhone /></span>  {airline?.phone}
                                                            </li>
                                                            <li className="text-lowercase">
                                                                <span className="la d-inline-block"><FaGlobeAmericas /></span> {airline?.fax}
                                                            </li>
                                                        </ul>
